...
namespace TensionDev.Maritime.NMEA0183
{
    ...
    public class DTMSentence : NMEASentence
    {
        ...
        public EarthCentredDatumEnum LocalDatumEarthCentred
        {
            get
            {
                switch (LocalDatumCode)
                {
                    case "W84":
                        return EarthCentredDatumEnum.WGS84;
                    case "W72":
                        return EarthCentredDatumEnum.WGS72;
                    case "S85":
                        return EarthCentredDatumEnum.SGS85;
                    case "P90":
                        return EarthCentredDatumEnum.PE90;
                    case "999":
                    default:
